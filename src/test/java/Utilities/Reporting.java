...
public class Reporting extends TestListenerAdapter {
    ...
    public void onStart(ITestContext testContext){
        ...
        htmlReporter.loadXMLConfig("extent-reports.xml");

        extent = new ExtentReports();

        extent.attachReporter(htmlReporter);

        extent.setSystemInfo("Host name","Empty");
        extent.setSystemInfo("Environment","Empty");
        extent.setSystemInfo("user","QA");

        htmlReporter.config().setDocumentTitle("Hybrid Framework");
